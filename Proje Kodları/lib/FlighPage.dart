...
class _FlightOffersScreenState extends State<FlightOffersScreen> {
  ...
  void initState() {
    super.initState();
    // Başlangıçta varsayılan değerleri kullanabilirsiniz
    flightOffers = getFlightOffers('DIY', 'ESB');
  }

  Future<List<FlightOffer>> getFlightOffers(String kalkis, String inis) async {
